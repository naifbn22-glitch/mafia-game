      ...
      >
        ...
        <div class="rules-flow-grid">
          <article class="rules-flow-card rules-flow-card--night">
            <div class="rules-flow-icon">🌙</div>
            <h4>1. الليل</h4>
            <p>تستيقظ الأدوار الخاصة وتنفذ مهامها بترتيب محدد.</p>
          </article>

          <article class="rules-flow-card rules-flow-card--day">
            <div class="rules-flow-icon">☀️</div>
            <h4>2. النهار</h4>
            <p>يستيقظ الجميع، وتبدأ المناقشة وتحليل أحداث الليلة.</p>
          </article>

          <article class="rules-flow-card rules-flow-card--vote">
            <div class="rules-flow-icon">🗳️</div>
            <h4>3. التصويت</h4>
            <p>يصوّت اللاعبون لاختيار شخص واحد لإخراجه من اللعبة.</p>
          </article>

          <article class="rules-flow-card rules-flow-card--result">
            <div class="rules-flow-icon">📢</div>
            <h4>4. النتائج</h4>
            <p>تُعلن نتيجة التصويت، ويُطبّق العفو إن وُجد، ثم تُحدّث حالة اللاعبين.</p>
          </article>

          <article class="rules-flow-card rules-flow-card--end">
            <div class="rules-flow-icon">🏆</div>
            <h4>5. نهاية اللعبة</h4>
            <p>تُفحص شروط الفوز، وإن لم تنتهِ المباراة تبدأ جولة جديدة من مرحلة الليل.</p>
          </article>
        </div>
